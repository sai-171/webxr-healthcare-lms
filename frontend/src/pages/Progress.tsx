...
export const ProgressPage: React.FC = () => {
  ...
  const getActivityIcon = (type: string) => {
    switch (type) {
      ...
      case 'ar': return <Target className="w-4 h-4" />;
      ...
      <div className="bg-gradient-to-r from-primary-600 to-secondary-600 rounded-lg p-6 text-white">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-primary-100">Keep up the great work, {user?.name}!</p>
          </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-white p-6 rounded-lg border border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900">{progressStats.coursesCompleted}</p>
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900">{progressStats.studyHours}</p>
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900">{progressStats.arSessions}</p>
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900">{progressStats.achievements}</p>
            ...
            <div key={activity.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div className="flex items-center space-x-3">
                <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${
                  ...
                  activity.type === 'ar' ? 'bg-blue-100 text-blue-600' :
